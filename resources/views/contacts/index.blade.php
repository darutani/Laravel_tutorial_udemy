        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="GET" action="{{ route('contacts.index') }}" class="my-10">
                        <input type="text" name="search" placeholder="検索" value="{{ $search }}">
                        ...
                        <table class="table-auto w-full text-left whitespace-no-wrap">
                            ...
                            <tbody>
                                @foreach ($contacts as $contact )
                                    ...
                                    <td class="border-t-2 border-gray-200 px-4 py-3 text-blue-900"><a href="{{ route('contacts.show', ['id' => $contact->id]) }}">詳細をみる</a></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
